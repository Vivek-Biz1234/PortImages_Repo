...
class RdataTB {
    ...
    Control() {
        ...
        span1.innerHTML = `
        <table id="C" border="0" style="width:100%;margin-bottom:0px;">
        <tr>
          <td style="width:100%; display: flex; justify-content: space-between; padding: 15px;white-space: nowrap;">
             ...
             <button type="button" class="btn btn-sm btn-success">Photo Download <i class="ti ti-download"></i></button>
             <button type="button" class="btn btn-sm btn-success">Container Photo Download <i class="ti ti-download"></i></button>
             <button type="button" class="btn btn-sm btn-success">CSV Download <i class="ti ti-download"></i></button>
             </div>
          </td>
        </tr>
      </table>
    ...
    paginateRender() {
        const k = `
        <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 px-3 pb-3">
                    ...
                    <ul class="pagination mb-0 justify-content-center align-items-center">
                        <li class="page-item">
                            <a class="page-link icon" aria-label="Previous" id="x__PREV__X">
                                <i class="ti ti-arrow-narrow-left">west</i>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link icon" aria-label="Next" id="x__NEXT__X">
                                <i class="ti ti-arrow-narrow-right">east</i>
                            </a>
                        </li>
                    </ul>
                </nav>
